...
if __name__ == "__main__":
    ...
    argparser.add_argument('-db', '--database',
        ...
        help="The name or path for the database connection config file to use.",
        default=r".\config\config_database.json")
    ...
    config["database"] = get_setup(filename=args.database_config)
